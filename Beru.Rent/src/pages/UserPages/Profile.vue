  ...
  <div class="col-md-3"></div>
      <v-card color="white" height="100%">
        ...
        <div class="contacts">
          ...
          <p class="user-info">Почта: {{user.mail}}</p>
          <p class="user-info user-phone">Телефон: {{user.phone}}</p>
        </div>
        <br />
        <br />
        <br />
...
export default{
  ...
  methods: {
    get() {
      axios.get('http://localhost:5181/api/user/getByMail', {params: {UserId: '78a4b3b7-70b3-42e9-93dc-8765750a40dd',
          Mail: 'mansurbauyrzanly@gmail.com'}})
