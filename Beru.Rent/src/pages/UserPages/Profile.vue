...
<template>
  <div class="col-md-3"></div>
      <v-card color="#FFCA28" height="100%">
...
<!--            <div>
              <v-img :src=this.avatar alt="Фото Юзера" style="border-radius: 50%; width:250px; height:250px;"></v-img>
              <p class="user-info-title">{{ user.firstName }} {{ user.lastName }} </p>
            </div>-->
            <div>
              <img :src=this.avatar alt="Фото Юзера" style="border-radius: 50%;width:225px; height:225px;">
              <p class="user-info-title">{{ user.firstName }} {{ user.lastName }} </p>
            </div>
      ...
      <div style="margin:0px; padding:0px">
        <v-container>
          ...
          <v-btn >
            <router-link style="text-decoration: none; color: inherit;" :to="'allChats'">Сделки</router-link>
          </v-btn>
          <v-btn >
